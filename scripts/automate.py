...
def get_group_info(groups, ast):
    ...
    def handle_function_node(node):
        ...
        if generator.visit(node.type.args) == 'void':
            ...
            for carg, carg_t, pyarg, pyarg_t in zip(cnode.type.args.params, cnode_t.type.args.params, pynode.type.args.params, pynode_t.type.args.params):
        ...
        if cnode.type.args.params:
            arg0 = cnode.type.args.params[0]
            while hasattr(arg0, 'type'):
                arg0 = arg0.type
            arg0_t = ' '.join(arg0.names)
        else:
            arg0_t = None
        ...
        return {
            ...
            'pyname': pynode.name,
            # attributes
            'arg0_t': arg0_t,  # probably not needed
            'group': group,
            # AST nodes
            'cnode': cnode,
            'cnode_t': cnode_t,
